...
<title>${htmlEscape(title)} · HubApp</title>
...
<div class="promo-foot">
  <a href="https://hubapp.pro.br/" target="_blank" rel="noopener">${htmlEscape(footer)}</a> · <a href="https://hubapp.pro.br/" target="_blank" rel="noopener">${htmlEscape(knowZpro)}</a>
</div>
<script>
...
app.post("/api/settings", apiLimiter, requireAdmin, (req: Request, res: Response) => {
  ...
  if (typeof b.youtubeChannelUrl === "string") store.saveSettings({ youtubeChannelUrl: b.youtubeChannelUrl.trim() });
  res.json(getGlobalPublicConfig());
});
